...
requirements = python3,kivy,sdl2_ttf,pillow,asyncio,io,typing,PIL,TikTokLive,random,math,pygame_textinput,pygame,vector,entities,enum
...
swordimg.filename = %(source.dir)s/data/swordimg.png
